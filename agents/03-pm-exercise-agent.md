...
> **The Setting:** You are a PM in the Supply pillar at Printify, responsible for onboarding new products and decoration methods. Your users include Decorators and internal operational/commercial teams.
>
> **The Situation:** Category Management colleagues are excited — a set of Decorators are purchasing premium leather goods that can be decorated. They believe merchants want to design on these products and consumers want to buy them.
>
...
Base your recommendation on: effort/impact ratio, strategic fit with Printify's merchant base, and Supply team capacity.
```
